  ...
  theme: {
    ...
    extend: {
      ...
      spacing: {
        ...
        "card-header-y": "var(--component-card-header-padding-y)",
        "cell-x": "var(--component-table-cell-padding-x)",
        "cell-y": "var(--component-table-cell-padding-y)",
        "grid-gap": "var(--component-grid-gap)",
        "sidebar-x": "var(--component-sidebar-padding-x)",
        "sidebar-w": "var(--component-sidebar-width)",
      },
      borderRadius: {
